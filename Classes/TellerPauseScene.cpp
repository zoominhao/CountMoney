...
Scene* TellerPauseScene::createScene(RenderTexture* sqr, int score)
{
	auto scene = Scene::create();
	auto layer = TellerPauseScene::create();
...
bool TellerPauseScene::init()
{
	...
	Btn_Return->addTouchEventListener(CC_CALLBACK_2(TellerPauseScene::returnCallback, this));

	ui::Button *Btn_Continue = dynamic_cast<ui::Button*>(uilayer->getChildByName("Continue"));
	Btn_Continue->addTouchEventListener(CC_CALLBACK_2(TellerPauseScene::continueCallback, this));

	ui::Button *Btn_Restart = dynamic_cast<ui::Button*>(uilayer->getChildByName("Restart"));
	Btn_Restart->addTouchEventListener(CC_CALLBACK_2(TellerPauseScene::restartCallback, this));
...
void TellerPauseScene::continueCallback(Ref *pSender, ui::Widget::TouchEventType type)
{
...
void TellerPauseScene::restartCallback(Ref *pSender, ui::Widget::TouchEventType type)
{
	if (type == ui::Widget::TouchEventType::ENDED)
	{
...
void TellerPauseScene::returnCallback(Ref *pSender, ui::Widget::TouchEventType type)
{
	if (type == ui::Widget::TouchEventType::ENDED)
	{
