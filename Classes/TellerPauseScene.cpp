...
bool TellerPauseScene::init()
{
	...
	auto continueItem = MenuItemImage::create(
		"start_icon1.png",
		"start_icon2.png",
		CC_CALLBACK_1(TellerPauseScene::continueCallback, this));
	...
	auto restartItem = MenuItemImage::create(
		"restart_icon1.png",
		"restart_icon2.png",
		CC_CALLBACK_1(TellerPauseScene::restartCallback, this));
...
void TellerPauseScene::continueCallback(Ref *pSender)
{
	Director::sharedDirector()->popScene();
}

void TellerPauseScene::restartCallback(Ref *pSender)
{
